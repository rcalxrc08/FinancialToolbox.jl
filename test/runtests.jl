...
test_list = ["testRealNumbers.jl","test_implied_volatility.jl", "testComplexNumbers.jl", "testForwardDiff.jl", "testDual_.jl", "testHyperDualNumbers.jl", "testDates.jl", "testTaylor.jl", "testZygote.jl"]
